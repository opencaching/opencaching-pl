...
//					$geokrety_content .= "Przebyty dystans: ".$geokret['distance']."km<br /><br />";
			...
			$cache_stats = "<a href=\"#\" onclick=\"javascript:window.open('cache_stats.php?cacheid=".$cache_record['cache_id']."&amp;popup=y','Cache_Statistics','width=450,height=750,resizable=yes,scrollbars=0')\"><img src=\"tpl/stdstyle/images/blue/stat1.png\" alt=\"\" title=\"Zobacz statystyke skrzynki\" /></a>";
			} else {
			$cache_stats="";}
