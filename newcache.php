 ...
 ****************************************************************************/
  ...
  //prepare the templates and include all neccessary
	...
	//				tpl_set_var('toschecked', '');
				...
				{
				$title="";
				if ($type['id']==1) {$title="Inny typ - skrzynka nie pasująca do żadnej z poniższych kategorii ale zawierająca pojemnik i logbook. Wskazówki dotarcia do tego logbooka mogą być różnorakie.";}
