  ...
  //prepare the templates and include all neccessary
	...
	if ($error == false)
	{
		...
		else
		{
			...
			tpl_set_var('new_cache', tr('new_cache'));
			tpl_set_var('basic_information', tr('basic_information'));
			tpl_set_var('first_cache', tr('first_cache'));
			...
			tpl_set_var('mandatory_field', tr('mandatory_field'));
			tpl_set_var('full_description', tr('full_description'));
			tpl_set_var('full_desc_long_text', tr('full_desc_long_text'));
			tpl_set_var('description_hint', tr('description_hint'));
			tpl_set_var('no_javascript', tr('no_javascript'));
			tpl_set_var('html_usage', tr('html_usage'));
			tpl_set_var('available_html', tr('available_html'));
			tpl_set_var('additional_enc_info', tr('additional_enc_info'));
			tpl_set_var('other', tr('other'));
			tpl_set_var('add_photo_newcache', tr('add_photo_newcache'));
			tpl_set_var('date_hidden_label', tr('date_hidden_label'));
			tpl_set_var('event_hidden_hint', tr('event_hidden_hint'));
			tpl_set_var('submit_new_cache', tr('submit_new_cache'));
			tpl_set_var('publish_now', tr('publish_now'));
			tpl_set_var('publish_date', tr('publish_date'));
			tpl_set_var('hour', tr('hour'));
			tpl_set_var('dont_publish_yet', tr('dont_publish_yet'));
			...
			tpl_set_var('password_info_label', tr('password_info_label'));
			tpl_set_var('creating_cache', tr('creating_cache'));
			tpl_set_var('rules', tr('rules'));
			tpl_set_var('with_all_consequences', tr('with_all_consequences'));
