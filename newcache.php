...
if ($error == false) {
    if ($usr == false) { //user logged in?
        ...
        if ($show_all_countries == 1) {
            ...
            tpl_set_var('show_all_countries_submit', '<input class="btn btn-default btn-xs" type="submit" name="show_all_countries_submit" value="' . $show_all . '"/>');
        }
...
function buildDescriptionLanguageSelector($show_all_langs, $lang, $defaultLangugaeList, $db, $show_all, $show_all_langs)
{
    ...
    tpl_set_var('show_all_langs_submit', '<input class="btn btn-default btn-xs" type="submit" name="show_all_langs_submit" value="' . $show_all . '"/>');
    if ($show_all_langs == 1) {
