 ...
 ****************************************************************************/
  ...
  //prepare the templates and include all neccessary
	...
	//				tpl_set_var('toschecked', '');
				...
				if ($type['id']==1) {$title="Inny typ - posiadają skrzynki, które nie pasują do żadnej z pozostałych definicji typów skrzynek ale posiadają fizyczny pojemnik oraz dziennik papierowy. Wskazówki dotarcia do tego logbooka mogą być różnorakie. ";}
				if ($type['id']==2) {$title="Tradycyjna - w przypadku skrzynki tradycyjnej, wymagane jest, by współrzędne wskazywały precyzyjnie miejsce ukrycia skrzynki, gdyż na ich podstawie musi być możliwe jej odnalezienie. Nie trzeba spełniać żadnych dodatkowych wymogów w terenie aby dokonać wpisu w logu internetowym. Skrzynka zawiera dziennik papierowy. ";}
