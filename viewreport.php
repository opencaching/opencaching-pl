...
if ($error == false && $usr['admin']) {
    ...
    <br />
    <input class='btn btn-primary btn-sm' type='submit' value=" . tr('cache_reports_29') . ">
    <a class='btn btn-default btn-sm' href='viewreport.php?reportid=" . $_REQUEST['reportid'] . "'>" . tr('cache_reports_30') . "</a>
    <br/>
";
...
//          $email_headers .= "CC: $octeam_email\r\n$octeam_email";
    ...
    if($report = XDb::xFetchArray($query)){
        ...
        $content .= "</select><br /><input class='btn btn-default btn-sm' type='submit' name='new_resp' value=" . tr('cache_reports_20') . ">";
        $content .= "</td>";
        ...
        $content .= "</select><br /><input type='hidden' name='reportid' value='" . $report['report_id'] . "'><input class='btn btn-default btn-sm' type='submit' name='new_status' value=" . tr('cache_reports_20') . ">";
        ...
        if (!isset($_GET['mailto'])) {
            $active_form = "<input type='hidden' name='reportid' value='" . intval($_REQUEST['reportid']) . "'/><textarea name='note' cols='80' rows='5'></textarea><br /><input class='btn btn-default btn-sm' type='submit' value=" . tr('cache_reports_23') . ">&nbsp;" . $saved;
