...
-- THIS IS SPARTAAAAAA!
alter table `cache_desc` modify column desc_html tinyint(1) not null default '0' comment 'Format for desc column: 0-plain text, which is actualy HTML with only <br/>s; 1-unsafe HTML; 2-safe HTML';
