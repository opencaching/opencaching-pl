...
// TODO
                ...
                if (isset($_POST['type'])) {
                    if( (($_POST['type'] == cache::TYPE_OTHERTYPE && $cache_record['type'] != cache::TYPE_OTHERTYPE )
                            || ($_POST['type'] == cache::TYPE_TRADITIONAL )
                            || ($_POST['type'] == cache::TYPE_MULTICACHE )
                            || ($_POST['type'] == cache::TYPE_QUIZ )
                            || ($_POST['type'] == cache::TYPE_MOVING ) ) && $sel_size == $CACHESIZE['NO_CONTAINER'] )
                    {
                        $error = true;
                        $size_not_ok = true;
                    }
