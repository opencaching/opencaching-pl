...
//				$this->caching = false;
		...
		if (isset($opt['locale'][$opt['template']['locale']]['page']['name']))
			$optn['page']['name'] = $opt['locale'][$opt['template']['locale']]['page']['name'];
		else
			$optn['page']['name'] = $opt['page']['name'];
    ...
    {
			$translate->initTranslation('all', 'OcSmarty.class.php');
