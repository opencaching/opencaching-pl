 ...
 ***************************************************************************/
	...
	function sql($sql)
	{
		...
		*/
		...
		if (isset($db['debug']) && ($db['debug'] == true))
		{
			...
			$result = $sqldebugger->execute($filtered_sql);
		...
		else
		{
			...
			$result = @mysql_query($filtered_sql, $db['dblink']);
			if ($result === false) sql_error();
	...
	*/
	...
	{
		global $db;
		if (isset($db['debug']) && ($db['debug'] == true) && isset($db['affected']))
			return $db['affected'];
		else
	...
	function sql_disconnect()
	{
		...
		else if (($opt['db']['pconnect'] == true) && ($db['dblink'] !== false))
		{
