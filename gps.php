...
/* Contributed by Kamil "Limak" Karczmarczyk (kkarczmarczyk *at* gmail com).
   *
   * - adGpsInfo() function is changed to better one for
   *   Opencaching.pl site (it's included in newpic.php file):
   *     - input==output
   *     - artist & maker added
   *     - altitude & date_time erased
   * - erase error_reporting(E_ALL) command.
*/
 ...
 */
function addGpsInfo($input, $description, $comment, $artist, $make, $model,
                    $longitude, $latitude) {
