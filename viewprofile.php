...
//------------ begin created caches ---------------------------			
			...
			{$content .= '&nbsp;&nbsp;&nbsp;<img src="tpl/stdstyle/images/blue/arrow.png" alt="" /> (<a href="search.php?searchto=searchbyowner&amp;showresult=1&amp;expert=0&amp;output=HTML&amp;sort=bycreated&amp;ownerid=' . $user_id . '&amp;f_inactive=0&amp;f_ignored=0&amp;f_userfound=0&amp;f_userowner=0&amp;f_watched=0&amp;f_geokret=0&amp;country=&amp;cachetype=0000010000">'.tr('show').'</a>)</p>';}
	...
	$rs_logs = sql("SELECT cache_logs.cache_id AS cache_id,
			...
			{
				$content .= '<p>&nbsp;</p><p><span class="content-title-noshade txt-blue08" >Najnowsze wpisy w logach w skrzynkach użytkownika:</span> &nbsp;<span style="font-weight: 400;">[<a href="myhome2.php">{{show_all}}</a>]</span></p><br /><div><ul style="margin: -0.9em 0px 0.9em 0px; padding: 0px 0px 0px 10px; list-style-type: none; line-height: 1.6em; font-size: 12px;">';
...
//			{
	...
	$rs_logs = sql("SELECT cache_logs.cache_id AS cache_id,
			...
			if (mysql_num_rows($rs_logs) != 0) {
				...
				$content .= '<p>&nbsp;</p><p><span class="content-title-noshade txt-blue08" >Najnowsze wpisy do logów wprowadzone przez użytkownika:</span></p><br /><div><ul style="margin: -0.9em 0px 0.9em 0px; padding: 0px 0px 0px 10px; list-style-type: none; line-height: 1.2em; font-size: 115%;">';
				for ($i = 0; $i < mysql_num_rows($rs_logs); $i++)
					{
					$record_logs = sql_fetch_array($rs_logs);
					$tmp_log = $log_line;
