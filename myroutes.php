...
//							$routes .= '<div style="margin-left:5px;width:75px;" class="myr">'.$routes_record['name']. '</div><div class="ver35">&nbsp;</div><div style="width:295px;" class="myr">'.nl2br($desc).'</div><div class="ver35">&nbsp;</div><div style="width:60px;text-align:center;" class="myr">'.$routes_record['radius']. ' km</div><div class="ver35">&nbsp;</div><div style="width:60px;text-align:center;" class="myr">'.round($routes_record['length'],0). ' km</div><div class="ver35">&nbsp;</div><div style="width:70px;float:left;text-align:center;"><a class="links" href="myroutes_search.php?routeid='.$routes_record['route_id'].'"><img src="tpl/stdstyle/images/action/16x16-search.png" alt="" title="Search caches along route" /></a></div><div class="ver35">&nbsp;</div><div style="width:50px;float:left;text-align:center;"><a class="links" href="myroutes_edit.php?routeid='.$routes_record['route_id'].'"><img src="images/actions/edit-16.png" alt="" title="Edit route" /></a></div><div class="ver35">&nbsp;</div><div style="width:20px;float:left;text-align:center;"><a class="links" href="myroutes_edit.php?routeid='.$routes_record['route_id'].'&delete" onclick="return confirm(\'Czy chcesz usunąć tę trase?\');"><img src="tpl/stdstyle/images/log/16x16-trash.png" alt="" title="Usuń" /></a></div></div>';
							$routes .= '<table border="0" class="myr"><tr><td style="margin-left:3px;width:75px;" class="myr">'.$routes_record['name']. '</td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:295px;" class="myr">'.nl2br($desc).'</td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:60px;" class="myr">'.$routes_record['radius']. ' km</td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:60px;" class="myr">'.round($routes_record['length'],0). ' km</td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:70px;" class="myr"><a class="links" href="myroutes_search.php?routeid='.$routes_record['route_id'].'"><img src="tpl/stdstyle/images/action/16x16-search.png" alt="" title="Search caches along route" /></a></td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:50px;" class="myr"><a class="links" href="myroutes_edit.php?routeid='.$routes_record['route_id'].'"><img src="images/actions/edit-16.png" alt="" title="Edit route" /></a></td><td><img  src="images/spacer.gif" height="40" width="1" alt="" align="middle" hspace="3" ></td>
							<td style="width:20px;" class="myr"><a class="links" href="myroutes_edit.php?routeid='.$routes_record['route_id'].'&delete" onclick="return confirm(\'Czy chcesz usunąć tę trase?\');"><img style="vertical-align: middle;" src="tpl/stdstyle/images/log/16x16-trash.png" alt="" title="Usuń" /></a></td></tr></table></div>';
