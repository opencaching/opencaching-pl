...
/***************************************************************************
	...
	***************************************************************************/
	...
	$error_queryname_exists = '<tr><td colspan="2" class="errormsg">The specified name already exists</td></tr>';
	$error_empty_name = '<tr><td colspan="2" class="errormsg">Specify a name to save your search options</td></tr>';
	$viewquery_line = '<tr>
											...
											<td bgcolor="{bgcolor}" width="10%" style="text-align: right; vertical-align: middle;">[<a href="search.php?queryid={queryid}&showresult=0">Search</a>]</td>
										</tr>
										<tr>
										...
										';
	$noqueries = '<tr><td colspan="2">There are no saved searches</td></tr>';
	
	$saveastext = 'Select a saved search in order to overwrite';
	$nosaveastext = 'there is no saved search options';
