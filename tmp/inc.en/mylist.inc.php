 ...
 ****************************************************************************/
	...
	$standard_title = 'Clipboard';
	$no_list = '<tr><td colspan="4">Not found any caches in the clipboard</td></tr>';
	...
	$list_o = '<tr bgcolor=\'#eeeeee\'><td><a href="viewcache.php?cacheid={urlencode_cacheid}">{cachename}</a></td><td>&nbsp;</td><td nowrap style="text-align:center;">{lastfound}</td><td nowrap style="text-align:center;">[<a href="removelist.php?cacheid={cacheid}&target=mylist.php">Delete</a>]</td></tr>';
	$no_found_date = '---';
	$print_delete_list = '<tr><td colspan="2">&nbsp;</td><td nowrap style="text-align:center;">[<a href="printcache.php?source=mylist">Print All</a>]</td><td nowrap style="text-align:center;">[<a href="removelist.php?cacheid=all&target=mylist.php">Remove all</a>]</td></tr>';
	$export_list = '
				<tr>
					<td colspan="4">Get data for caches on clipboard :
						...
						<br />
						<span class="help">Downloading data from Opencaching.se requires accepting <a href="articles.php?page=impressum#tos">conditions of use.</a>.</span>
					</td>
				</tr>';
?>