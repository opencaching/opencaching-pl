 ...
 ****************************************************************************/
	...
	$watche = '<tr><td><a href="viewcache.php?cacheid={urlencode_cacheid}">{cachename}</a></td><td>&nbsp;</td><td nowrap style="text-align:center;">{lastfound}</td><td nowrap style="text-align:center;">[<a href="removewatch.php?cacheid={cacheid}&target=mywatches.php">Delete</a>]</td></tr>';
	$watcho = '<tr bgcolor=\'#eeeeee\'><td><a href="viewcache.php?cacheid={urlencode_cacheid}">{cachename}</a></td><td>&nbsp;</td><td nowrap style="text-align:center;">{lastfound}</td><td nowrap style="text-align:center;">[<a href="removewatch.php?cacheid={cacheid}&target=mywatches.php">Delete</a>]</td></tr>';
	$no_watches = '<tr><td colspan="4">No watched caches found</td></tr>';
	$no_found_date = '---';
	$standard_title = 'Watched caches';
	$print_delete_all_watches = '<tr><td colspan="2">&nbsp;</td><td nowrap style="text-align:center;">[<a href="printcache.php?source=mywatches">Print All</a>]</td><td nowrap style="text-align:center;">[<a href="removewatch.php?cacheid=all&target=mywatches.php">Remove all</a>]</td></tr>';
	$export_all_watches = '
				<tr>
					<td colspan="4">Download watched caches data:
						...
						<br />
						<span class="help">Downloading data from Opencaching.se requires accepting <a href=http://opencaching.se/articles.php?page=T_O_S>conditions of use.</a>.</span>
					</td>
				</tr>';
?>
