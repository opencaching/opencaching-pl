...
tpl_set_tplname('myneighborhood');
...
tpl_set_var('distance_unit', $distance_unit);
...
if ($limit == 0) {
   $file_content = "<p class=\"notice\">" . tr('list_of_caches_is_empty') . "</p>";
} else {
    $cacheline = '
        <tr>
            <td class="myneighborhood tab_icon"><img src="{cacheicon}" class="icon16" alt="{{cache}}"></td>
    ...
    $file_content = '<table class="table full-width table-striped">';
...
$file_content = '';
if ( $db->rowCount($s) == 0) {
    $file_content = "<p class=\"notice\">" . tr('list_of_events_is_empty') . "</p>";
} else {
    $cacheline = '
    <tr>
        <td class="myneighborhood tab_icon"><img src="{cacheicon}" class="icon16" alt="{{cache}}"></td>
...
if ( $db->rowCount($s) == 0) {
    $file_content = "<p class=\"notice\">" . tr('list_of_latest_logs_is_empty') . "</p>";
} else {
    $cacheline = '
        <tr>
            <td class="myneighborhood tab_icon"><a id="logcache{nn}" class="links" href="viewcache.php?cacheid={cacheid}"><img src="{cacheicon}" class="icon16" alt="{{cache}}"></a></td>
            <td class="myneighborhood tab_date">{date}</td>
...
if ($limit == 0) {
    ...
    $cacheline = '
            <tr>
                <td class="myneighborhood tab_icon"><img src="{cacheicon}" class="icon16" alt="{{cache}}"></td>
                <td class="myneighborhood tab_date">{date}</td>
                <td class="myneighborhood"><a id="mapcache{nn}" class="links" href="viewcache.php?cacheid={cacheid}" onmouseover="Lite({nn})" onmouseout="Unlite()" maphref="{smallmapurl}">{cachename}</a> <img src="images/rating-star.png"> ({toprate})</td>
                <td class="myneighborhood tab_user"><a class="links" href="viewprofile.php?userid={userid}">{username}</a></td>
            </tr>';
...
if ($limit == 0) {
    ...
    $Title_titledCaches = '<p class="content-title-noshade-size3"><img src="tpl/stdstyle/images/blue/TitledCache.png" class="icon32" alt=""> '.tr($ntitled_cache).'</p>';
