...
<table width="100%">
    <tr><td class="content2-pagetitle" style="background-color:#E9E9E9;"><img src="images/misc/32x32-winner.png" class="icon32" alt="{t}Special caches{/t}" title="{t}Special caches{/t}" align="middle" /><font size="4">  <b>{t}Special caches{/t}</b></font></td></tr>
...
<table width="100%">
    ...
    <tr>
        ...
        <td align="center"><img src="images/log/16x16-found.png" class="icon16" alt="{t}Found{/t}" /></td>
        <td>&nbsp;</td>
    </tr>
