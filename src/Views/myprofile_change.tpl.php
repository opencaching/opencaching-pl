  ...
  <form name="change" action="/myprofile.php?action=change" method="post" enctype="application/x-www-form-urlencoded"  style="display: inline;">
    <table class="table">
      ...
      <tr>
        <td>&nbsp;</td>
        <td>
          <div class="notice" style="max-width:500px;">{{GKApi03}} <a href="<?=GeoKretyApi::GEOKRETY_URL?>/mypage.php" target="_blank" rel="noopener">{{GKApi04}}</a></div>
        </td>
      </tr>
      {guide_start}
      <tr>
      ...
      <tr>
        ...
        <td class="txt-grey07" valign="top">
          ...
          <div class="notice" style="max-width:500px;">{{no_auto_logout_warning}}</div>
        </td>
      </tr>
      ...
      <tr class="form-group-sm">
        ...
        <td class="txt-grey07" valign="top"><input type="text" size="46" name="ozi_path" value="{ozi_path}" class="form-control input300"><br>
          <div class="notice" style="max-width:500px;">{{ozi_path_info}}</div>
          <div class="notice" style="max-width:500px;">{{ozi_path_info2}}</div>
        </td>
      </tr>
    </table>
