...
$tos_not_ok_message = '<br/><img src="images/misc/32x32-impressum.png" class="icon32" alt=""  />&nbsp;<span class="errormsg">' . tr('new_cache_no_terms') . '</span>';
$desc_not_ok_message = '<br/><img src="images/misc/32x32-impressum.png" class="icon32" alt=""  />&nbsp;<span class="errormsg">' . tr('html_incorrect') . '</span>';
...
$invalid_wp_gc_message = '<img src="images/misc/32x32-impressum.png" class="icon32" alt=""  />&nbsp;&nbsp;<span class="errormsg">' . tr('invalid_wp_gc') . '</span>';
$invalid_wp_tc_message = '<img src="images/misc/32x32-impressum.png" class="icon32" alt=""  />&nbsp;&nbsp;<span class="errormsg">' . tr('invalid_wp_tc') . '</span>';
$invalid_wp_ge_message = '<img src="images/misc/32x32-impressum.png" class="icon32" alt=""  />&nbsp;&nbsp;<span class="errormsg">' . tr('invalid_wp_ge') . '</span>';
...
$pictureline = '<tr class="form-group-sm"><td colspan="2">{seq_drop}<img src="images/free_icons/picture.png" class="icon32" alt="" />&nbsp;<a href="{link}" target="_blank">{title}</a>&nbsp;&nbsp;<img src="images/actions/edit-16.png" align="middle" alt="" title="" /> [<a href="editpic.php?uuid={uuid}" onclick="return check_if_proceed();"  >' . $edit . '</a>] <img src="images/log/16x16-trash.png" border="0" align="middle" class="icon16" alt="" title="" />[<a href="removepic.php?uuid={uuid}" onclick="if (confirm(\'' . tr('ec_delete_pic') . '\')) {return check_if_proceed();} else {return false;};">' . $remove . '</a>]</td></tr>';
