...
$remove_picture = '<span class="removepic"><img src="/images/log/16x16-trash.png" class="icon16" alt="Trash icon">&nbsp;<a class="links" href="/removepic.php?uuid={uuid}">' . tr("delete") . '</a></span> ';
