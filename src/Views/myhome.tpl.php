...
<div class="content2-pagetitle"><img src="/images/blue/home.png" class="icon32" alt="Moje konto" title="Moje konto" align="left" />
...
<p class="content-title-noshade-size3"><img src="/images/blue/logs.png" class="icon32" alt="Logs" title="Logs" />&nbsp;{{your_new_log_entries}}:</p>
<span style="font-weight: 400;">[<a href="my_logs.php">{{show_all}}</a>]</span><br/><br/>
<table class="table">
    {lastlogs}
</table>
<br/>
<p class="content-title-noshade-size3"><img src="/images/blue/cache.png" class="icon32" alt="Caches" title="Caches" />&nbsp;
