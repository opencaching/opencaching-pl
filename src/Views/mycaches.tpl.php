...
<div class="content2-pagetitle"><img src="/images/blue/cache.png" class="icon32" alt="" title="" align="middle"/>&nbsp;{{my_caches_status}}: <font color="black">{cache_stat}</font></div>
...
<div class="searchdiv">
    <table border="0" cellspacing="2" cellpadding="1" style="margin-left: 10px; line-height: 1.4em; font-size: 13px;" width="95%">
        <tr>
            ...
            <td align="middle"><a class="links" href="mycaches.php?col=3{my_cache_sort}" alt="{{mc_by_founds}}" title="{{mc_by_founds}}"><img src="images/log/16x16-found.png"></a></td>
            ...
            <td align="middle"><a class="links" href="mycaches.php?col=7{my_cache_sort}" alt="{{mc_by_visits}}" title="{{mc_by_visits}}"><img src="images/free_icons/vcard.png"></a></td>
