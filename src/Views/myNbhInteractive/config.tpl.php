...
<?php
$view->callChunk('interactiveMap/interactiveMap', $view->mapModel, 'nbhmapmain'); ?>
...
<?php
    if (sizeof($view->markersFamilies) > 1) { ?>
        <div class="buffer"></div>
        <fieldset id="family-chooser-fset">
            <legend>&nbsp;<?= tr('myn_family_lbl'); ?>&nbsp;</legend>
<?php
        foreach ($view->markersFamilies as $family) { ?>
