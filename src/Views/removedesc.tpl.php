...
<form name="descform" action="removedesc.php" method="get" enctype="application/x-www-form-urlencoded" id="removedesc_form" dir="ltr">
    ...
    <div class="content2-pagetitle"><img src="/images/blue/trash.png" class="icon32" alt="" title="" align="middle" />&nbsp;{{remove_description}} <a href="viewcache.php?cacheid={cacheid}">{cachename}</a></div>
    <p>&nbsp;</p>
