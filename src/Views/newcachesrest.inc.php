...
$tpl_line = '<tr><td style="width: 70px;">{date}</td><td style="width: 22px;">{gkimage}</td><td style="width: 22px;">{GPicon}</td><td style="width: 22px;">{logimage}</td><td style="width: 22px;"><img src="{imglink}" class="icon16" alt="" title="Cache" style="margin-top:4px;"></td><td><b><a class="links" href="viewcache.php?cacheid={cacheid}">{cachename}</a></b></td><td><b><a class="links" href="viewprofile.php?userid={userid}">{username}</a></b></td></tr>';
