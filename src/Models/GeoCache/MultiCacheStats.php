...
class MultiCacheStats extends BaseObject
{
     ...
     * @return array
     */
    private static function getLatestNationalCachesId(): array
    {
     ...
     * @return int
     */
    public static function getLatestNationalCachesCount(): int
    {
     ...
     * @return array
     */
    public static function getLatestNationalCachesForUser($user, int $limit, int $offset = 0): array
    {
     ...
     * @return array
     */
    public static function getLatestForeignCachesForUser($user = null): array
    {
     ...
     * @return array
     */
    public static function getLatestEventsForUser($user = null): array
    {
     ...
     * @return array
     */
    private static function getTitledCachesId(): array
    {
     ...
     * @return int
     */
    public static function getTitledCount(): int
    {
     ...
     * @return array
     */
    public static function getTitledCachesForUser($user, int $limit, int $offset = 0): array
    {
     ...
     * @return array
     */
    private static function getRecommendedCachesId(): array
    {
     ...
     * @return int
     */
    public static function getRecommendedCount(): int
    {
     ...
     * @return array
     */
    public static function getRecommendedCaches(int $limit, int $offset = 0): array
    {
