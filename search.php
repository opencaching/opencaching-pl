...
function outputSearchForm($options)
{
  ...
  if ($lang != 'pl') { $lang = 'en'; }
	...
	tpl_set_var('search_wildcard_info', $language[$lang]['search_wildcard_info']);
	tpl_set_var('sort_by', $language[$lang]['sort_by']);
	tpl_set_var('cache_name', $language[$lang]['cache_name']);
	tpl_set_var('distance_label', $language[$lang]['distance_label']);
	tpl_set_var('date_created_label', $language[$lang]['date_created_label']);
	tpl_set_var('omit_caches', $language[$lang]['omit_caches']);
	tpl_set_var('of_owner', $language[$lang]['of_owner']);
	tpl_set_var('not_active', $language[$lang]['not_active']);
	tpl_set_var('founds', $language[$lang]['founds']);
	tpl_set_var('ignored', $language[$lang]['ignored']);
	tpl_set_var('observed', $language[$lang]['observed']);
	tpl_set_var('geokret', $language[$lang]['without_geokret']);
	...
	tpl_set_var('search_recommendations', $language[$lang]['search_recommendations']);
	tpl_set_var('search_all_caches', $language[$lang]['search_all_caches']);
	tpl_set_var('search_recommended_caches', $language[$lang]['search_recommended_caches']);
	...
	tpl_set_var('with_hidden_score', $language[$lang]['with_hidden_score']);
	tpl_set_var('search', $language[$lang]['search']);
	tpl_set_var('search_by_distance', $language[$lang]['search_by_distance']);
	tpl_set_var('coordinates', $language[$lang]['coordinates']);
	tpl_set_var('search_by_name', $language[$lang]['search_by_name']);
	tpl_set_var('max_distance', $language[$lang]['max_distance']);
	tpl_set_var('kilometer', $language[$lang]['kilometer']);
	tpl_set_var('mile', $language[$lang]['mile']);
	tpl_set_var('nautical_mile', $language[$lang]['nautical_mile']);
	tpl_set_var('search_by_city', $language[$lang]['search_by_city']);
	tpl_set_var('city_name', $language[$lang]['city_name']);
	tpl_set_var('search_text', $language[$lang]['search_text']);
	tpl_set_var('text', $language[$lang]['text']);
	tpl_set_var('description', $language[$lang]['description']);
	tpl_set_var('logs_label', $language[$lang]['logs_label']);
	tpl_set_var('pictures', $language[$lang]['pictures']);
	tpl_set_var('search_by_owner', $language[$lang]['search_by_owner']);
	tpl_set_var('owner_label', $language[$lang]['owner_label']);
	tpl_set_var('finder_label', $language[$lang]['finder_label']);
	tpl_set_var('search_by_finder', $language[$lang]['search_by_finder']);
	tpl_set_var('search_cache', $language[$lang]['search_cache']);
