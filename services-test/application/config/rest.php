...
|
*/
$config['rest_default_format'] = 'gpx';
...
|
*/
$config['rest_realm'] = 'OpenCaching PL Node REST API';
...
//$config['auth_override_class_method']['cache']['index'] = 'none';
...
|
*/
$config['rest_valid_logins'] = array('admin' => '#asd5');
