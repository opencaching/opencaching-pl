...
//prepare the templates and include all neccessary
	...
	// calculate diif days between date of register on OC  to current date
	 ...
	 // sql ("SELECT COUNT(*) FROM cache_logs WHERE type=1 AND user_id=&1 GROUP BY GROUP BY YEAR(`date_created`), MONTH(`date_created`), DAY(`date_created`)",$user_id);
			...
			$content .= '<table style="border-collapse: collapse" border="0" width="750"><tr><td width="150" bgcolor="#C6E2FF"><b>Statystyka ogolna</b></td> <td width="200"><b><a href="ustatsg1.php?userid=' . $user_id . '">Wykresy skrzynek zalozonych</a></b></td> <td width="200"><b><a href="ustatsg2.php?userid=' . $user_id . '"> Wykresy skrzynek znalezionych</a></b></td><td width="300" ></td> </tr></table>';
			$content .='<table style="border-collapse: collapse" border="0" width="500"><tr><td colspan="4" bgcolor="#C6E2FF"><b>Ogólna statystyka liczbowa</b></td></tr></table>';	
	...
	if ($rsGeneralStat !== false){
			...
			$content .= '<b><p>Statystyka skrzynek założonych</p>Liczba wszytskich założonych skrzynek: ' . $user_record['hidden_count'] . '</p><p>Liczba dni zakladanych skrzynek: .... </p><p>Avg cache/day: ....</p><p>Most cache/day: ....</p><p>Pierwsza założona skrzynka: ....<p><p>Najnowsza załozona skrzynka: ....</p></b>';	

		}

		$content .= '<b><p>Statystka skrzynek znalezionych</p><p>Liczba znalezionych skrzynek: ' . $user_record['founds_count'] . '</p><p> Avg cache/day: .... </p>Most cache/day: ....</p><p>Pierwsz zanaleziona skrzynka: .... </p><p>Ostatnia znaleziona skrzynka: ....</p></b>';	


			$content .='<p><b>Odwiedzone województwa Polski podczas poszukiwan (w opracowaniu) </b></p><p><center><img src=images/PLmapa250.jpg alt="" /></center></p>';
