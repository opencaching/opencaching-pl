...
/* begin output */
    ...
    if ($bXmlDecl == '1') echo '<?xml version="1.0" encoding="iso-8859-2" standalone="no" ?>' . "\n";
    if ($bDocType == '1') echo '<!DOCTYPE oc10xml PUBLIC "-//Opencaching Network//DTD OCXml V 1.0//EN" "http://www.opencaching.pl/xml/ocxml10.dtd">' . "\n";
    if ($bOcXmlTag == '1') echo '<oc10xml version="1.0" date="' . date($sDateformat) . '" since="' . $sModifiedSince . '">' . "\n";
