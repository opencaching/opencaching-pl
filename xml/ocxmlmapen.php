...
/* begin output */
    ...
    if ($bXmlDecl == '1') echo '<?xml version="1.0" encoding="utf-8"?>' . "\n";
//  if ($bDocType == '1') echo '<!DOCTYPE oc10xml PUBLIC "-//Opencaching Network//DTD OCXml V 1.0//EN" "http://www.opencaching.pl/xml/ocxml10.dtd">' . "\n";
    if ($bOcXmlTag == '1') echo '<rss version="2.0" xmlns:geo="http://www.w3.org/2003/01/geo/wgs84_pos#" xmlns:ymaps="http://api.maps.yahoo.com/Maps/V2/AnnotatedMaps.xsd"><channel>
...
<Id>Mobile</Id>
<BaseIcon width="16" height="16"><![CDATA[http://opencaching.pl/tpl/stdstyle/images/cache/16x16-moving.png]]></BaseIcon>
</group>
...
// ' by ' . $username[$r['user_id']] .
            ...
            echo $t2 . '<description>' . 'Created by: ' . $username[$r['user_id']] . ' .::. Type: ' . $icon . ' .::. Difficulty: ' . sprintf('%01.1f', $r['difficulty'] / 2) . ' .::. Terrain: ' . sprintf('%01.1f', $r['terrain'] / 2) . '</description>' . "\n";
...
//          echo $t2 . '<ymaps:PhoneNumber>' . 'Teren: ' . $r['terrain'] . '</ymaps:PhoneNumber>' . "\n";
    ...
    if ($bOcXmlTag == '1') echo '</channel></rss>' . "\n";
