...
function displayAllCachesOfPowerTrail(\lib\Objects\PowerTrail\PowerTrail $powerTrail, $choseFinalCaches)
{
    ...
    foreach ($powerTrail->getGeocaches() as $geocache) {
        ...
        if ($geocache->isIsPowerTrailFinalGeocache()) {
            $cacheRows .= '<span class="finalCache">' . tr2('pt148') . '</span>';
        }
...
function ratings($score, $votes)
{
    ...
    switch ($scoreNum) {
        case 0: return '<span style="color: #790000">' . tr2('pt074', $language) . '</span>';
        case 1: return '<span style="color: #BF3C3C">' . tr2('pt073', $language) . '</span>';
        case 2: return '<span style="color: #B36200">' . tr2('pt072', $language) . '</span>';
