        ...
        <tr>
            ...
            <td class="content-title-noshade">
                <fieldset style="border: 1px solid black; width: 80%; height: 32%; background-color: #FAFBDF;" class="form-group-sm">
                    ...
                    &nbsp;<input type="text" id="lat_h"  name="lat_h" maxlength="2" class="form-control input30" onchange="checkRegion()" placeholder="0"  <?php if(isset($_POST['lat_h'])) { ?> value="{lat_h}" <?php } ?> />
                    &deg;&nbsp;<input type="text" id="lat_min" name="lat_min" maxlength="6" class="form-control input50" onkeyup="this.value = this.value.replace(/,/g, '.');" onchange="checkRegion()" placeholder="00.000" <?php if(isset($_POST['lat_min'])) { ?> value="{lat_min}" <?php } ?> />&nbsp;'&nbsp;
                    ...
                    &nbsp;<input type="text" id="lon_h" name="lon_h" maxlength="3" class="form-control input30" onchange="checkRegion()" placeholder="0" <?php if(isset($_POST['lon_h'])) { ?> value="{lon_h}" <?php } ?> />
                    &deg;&nbsp;<input type="text" id="lon_min" name="lon_min" maxlength="6" class="form-control input50" onkeyup="this.value = this.value.replace(/,/g, '.');" onchange="checkRegion()" placeholder="00.000" <?php if(isset($_POST['lon_min'])) { ?> value="{lon_min}" <?php } ?>/>&nbsp;'&nbsp;
