...
<div class="content2-pagetitle"><img src="tpl/stdstyle/images/blue/cache.png" border="0" width="32" height="32" alt="" title="{new_cache}" align="middle"/>&nbsp;{new_cache}</div>
	...
	<tr>
		<td class="bg-white" style="width:769px;margin:0 0 0 0;border-top:1px solid rgb(54,83,151);border-left:1px solid rgb(54,83,151);border-right:1px solid rgb(54,83,151);border-bottom:1px solid rgb(54,83,151);" colspan="2">
	...
	<tr><td colspan="2"><div class="buffer"></div></td></tr>
	<tr>
		<td class="bg-white" style="width:769px;margin:0 0 0 0;border-top:1px solid blue;border-left:1px solid blue;border-right:1px solid blue;border-bottom:1px solid blue;" colspan="2">
