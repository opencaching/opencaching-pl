...
<div class="content2-pagetitle"><img src="tpl/stdstyle/images/blue/logs.png" border="0" width="32" height="32" alt="" title="" align="middle"/>&nbsp;Kasowanie wpisu z logu dla skrzynki <a href="viewcache.php?cacheid={cacheid}">{cachename}</a></div>
