...
<div class="content2-pagetitle"><img src="tpl/stdstyle/images/blue/logs.png" class="icon32" alt="" />&nbsp;Kasowanie wpisu z logu dla skrzynki <a href="viewcache.php?cacheid={cacheid}" />{cachename}</a></div>
