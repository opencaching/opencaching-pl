		...
		<table class="content">
			...
			{start_przejmij}
			<tr><td class="header" colspan="2"><img src="tpl/stdstyle/images/profile/22x22-email.png" border="0" width="22" height="22" align="middle"> <b>	Przejmij skrzynkę</b></td></tr>
			...
			{end_przejmij}
			<tr><td class="header" colspan="2"><img src="tpl/stdstyle/images/profile/22x22-email.png" border="0" width="22" height="22" align="middle"> <b>	Przekaż skrzynkę</b></td></tr>
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr>
				<td>
					<table border='0' width='800'>
