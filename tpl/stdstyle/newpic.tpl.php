...
<table class="content">
	...
	<tr><td class="header" colspan="2"><img src="tpl/stdstyle/images/description/22x22-image.png" border="0" width="22" height="22" alt="" title="Neuw Cache" align="middle"> <b>{pictypedesc} <a href="/viewcache.php?cacheid={cacheid}">{cachename}</a></b></td></tr>
