...
<table class="content">
	...
	<tr><td class="content2-pagetitle" colspan="2"><img src="tpl/stdstyle/images/blue/picture.png" border="0" width="32" height="32" alt="" title="edit picture" align="middle"> <b>Edit {pictypedesc} </b><br><a href="/viewcache.php?cacheid={cacheid}">{cachename}</a></td></tr>
