...
/***************************************************************************
 ...
 $log_line = '<li style="margin: -0.9em 0px 0.9em 0px; padding: 0px 0px 0px 10px; list-style-type: none; line-height: 1.2em; font-size: 115%;">{rateimage}&nbsp;{logimage} &nbsp; <img src="tpl/stdstyle/images/{cacheimage}" border="0" alt="" />&nbsp; {date} &nbsp; <a href="viewcache.php?cacheid={cacheid}">{cachename}</a></li>';
 $cache_line_my_caches = '<li style="margin: -0.9em 0px 0.9em 0px; padding: 0px 0px 0px 10px; list-style-type: none; line-height: 1.2em; font-size: 115%;">{rateimage} &nbsp;{logimage} &nbsp; <img src="tpl/stdstyle/images/{cacheimage}" border="0" alt="" />&nbsp; {date} &nbsp; <a href="viewcache.php?cacheid={cacheid}">{cachename}</a> - <a href="viewprofile.php?userid={userid}">{username}</a></li>';
?>
