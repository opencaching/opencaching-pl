<?php
    $user_max_date_created = strtotime("2013-04-15 00:00:00");
    $user_min_found_caches = 10;
    $user_found_caches_date = strtotime("2013-05-15 00:00:00");

    $vote_time_start = strtotime("2013-06-01 00:00:00");
    $vote_time_end = strtotime("2013-06-14 23:59:59");

// Do testów
// $user_max_date_created = strtotime("2007-04-14 00:00:00");
// $user_min_found_caches = 1000;
// $vote_time_start = strtotime("2013-05-16 00:00:00");
// $vote_time_end = strtotime("2013-05-16 22:47:00");

    $just_voted = "<br /><b>Twój głos został zapisany. Dziękujemy za udział w głosowaniu. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania (tj. po godz. 23:59:59, 14 czerwca 2013 roku).</b>";
    $already_voted = "<br /><b>Oddałeś już swój głos na kandydatów. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania (tj. po godz. 23:59:59, 14 czerwca 2013 roku).</b>";
    $vote_ended = "<br /><b>Głosowanie do Rady Rejsu 2013 zostało zakończone. Poniżej prezentujemy wyniki głosowania.</b>";
    $vote_not_start = "<br /><b>Głosowanie rozpocznie się 1 czerwca 2013 roku o godzinie 00:00:00.</b>";
    ...
    $vote_info = '<br /><b>Regulamin uczestnictwa w wyborach do Rady Rejsu 2013</b><br /><br />
1. Głosowanie rozpocznie się 1 czerwca 2013 roku o godzinie 00:00:00 i trwać będzie do 14 czerwca 2013 roku do godziny 23:59:59.<br />
2. Do głosowania uprawniony jest każdy użytkownik serwisu OC PL, który spełnia następujące warunki:<br />
&nbsp;&nbsp;* zarejestrował się w serwisie na miesiąc przed ogłoszeniem wyborów, tj. przed 15 kwietnia 2013,<br />
&nbsp;&nbsp;* do dnia ogłoszenia wyborów, tj. do 15 maja 2013 miał znalezionych co najmniej 10 skrzynek.<br />
...
5. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania tj. po godzinie 23:59:59, 14 czerwca 2013 roku. Zwycięzcami wyborów będzie 5 osób z największą liczbą głosów.<br />';
