<?php
    $user_max_date_created = strtotime("2015-10-15 00:00:00");
    $user_min_found_caches = 10;
    $user_found_caches_date = strtotime("2015-12-14 00:00:00");

    $vote_time_start = strtotime("2015-12-14 00:00:00");
    $vote_time_end = strtotime("2015-12-22 23:59:59");
...
// $vote_time_end = strtotime("2014-05-27 21:25:00");
    ...
    $just_voted = "<br /><b>Twój głos został zapisany. Dziękujemy za udział w głosowaniu. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania (tj. po godz. 23:59:59, 22 grudnia 2015 roku).</b>";
    $already_voted = "<br /><b>Oddałeś już swój głos na kandydatów. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania (tj. po godz. 23:59 22 grudnia 2015 roku).</b>";
    $vote_ended = "<br /><b>Głosowanie do Rady Rejsu 2016 zostalo zakończone. Poniżej prezentujemy wyniki głosowania.</b>";
    $vote_not_start = "<br /><b>Głosowanie rozpocznie się 14 grudnia 2015 roku o godzinie 00:00:00.</b>";
    ...
    $vote_info = '<br /><b>Regulamin uczestnictwa w wyborach do Rady Rejsu 2016</b><br /><br />
1. Głosowanie rozpocznie się 14 grudnia 2015 roku o godzinie 00:00:00 i trwać będzie do 22 grudnia 2015 roku do godziny 23:59:59.<br />
2. Do głosowania uprawniony jest każdy użytkownik serwisu OC PL, który spełnia następujące warunki:<br />
&nbsp;&nbsp;* zarejestrował się w serwisie na miesiąc przed ogłoszeniem wyborów, tj. przed 15 października 2015 roku,<br />
&nbsp;&nbsp;* do dnia ogłoszenia wyborów, tj. do 15 listopada 2015 miał znalezionych co najmniej 10 skrzynek.<br />
3. Głosowanie polega na wyborze od 1 do 5 kandydatów z listy.<br />
4. Każdy uprawniony do głosowania może głosować tylko jeden raz i nie może zmienić ani uzupełnić oddanego uprzednio głosu.<br />
5. Wyniki głosowania zostaną opublikowane po zakończeniu głosowania tj. o godzinie 00:00:00, 23 grudnia 2015 roku. Zwycięzcami wyborów będzie 5 osób z największą liczbą głosów.<br />';
