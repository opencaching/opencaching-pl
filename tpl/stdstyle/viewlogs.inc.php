...
$remove_log = '<span id="rmLogLoader-{logid}" style="display: none"><img src="tpl/stdstyle/images/misc/ptPreloader.gif" />'.tr('removingLog').'..</span><span id="rmLogHrefSection-{logid}"><img src="tpl/stdstyle/images/free_icons/cross.png" class="icon16" alt="" title=""/>&nbsp;<a class="links" href="#" onclick="return rmLog(event, {logid});">' . tr("delete") . '</a></span>&nbsp;';
