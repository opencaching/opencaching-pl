 ...
 ****************************************************************************/
	...
	$decrypt_log = '<a href="viewcache.php?cacheid={cacheid}&amp;nocrypt=1#{decrypt_log_id}"><img src="tpl/stdstyle/images/free_icons/lock_open.png" class="icon16" alt="" title=""/></a>&nbsp;<a href="viewcache-test.php?cacheid={cacheid}&amp;nocrypt=1#{decrypt_log_id}" onclick="var ch = document.getElementById(\'{decrypt_log_id}\').childNodes;for(var i=0;i < ch.length;++i){amp;var e = ch[i]; decrypt(e);}amp; document.getElementById(\'decrypt-info\').style.display = \'none\'; return false;">'.tr('decrypt').'</a>';	
