 ...
 ****************************************************************************/
	...
	$decrypt_log = '<img  src="tpl/stdstyle/images/free_icons/lock_open.png" class="icon16" alt="" title=""/>&nbsp;<a href="viewcache-test.php?cacheid={cacheid}&amp;nocryptlog=1#{decrypt_log_id}" onclick="var ch = document.getElementById(\'{decrypt_log_id}\').childNodes;for(var i=0;i < ch.length;++i) {var e = ch[i]; decrypt(e);} document.getElementById(\'logid\').style.display = \'none\'; return false;">'.tr('decrypt').'</a>';	
