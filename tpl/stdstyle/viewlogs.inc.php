 ...
 ****************************************************************************/
	...
	$edit_log = '<a class="links" href="editlog.php?logid={logid}"><img src="tpl/stdstyle/images/action/16x16-properties.png" class="icon16" alt="" title=""/>&nbsp;Edycja</a>&nbsp;';
	$remove_log = '<a class="links" href="removelog.php?logid={logid}"><img src="tpl/stdstyle/images/log/16x16-trash.png" class="icon16" alt="" title=""/>&nbsp;Usuń</a>&nbsp;';
