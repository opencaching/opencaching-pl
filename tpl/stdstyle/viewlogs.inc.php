 ...
 ****************************************************************************/
	...
	$remove_log = '<a href="removelog.php?logid={logid}"><img src="tpl/stdstyle/images/log/16x16-trash.png" border="0" align="middle" border="0" width="16" height="16" alt="" title=""/></a>&nbsp;<a href="removelog.php?logid={logid}">Usuń</a>&nbsp;';
	$upload_picture = '<a href="newpic.php?objectid={logid}&type=1"><img src="tpl/stdstyle/images/action/16x16-addimage.png" border="0" align="middle" border="0" width="16" height="16" alt="" title=""/></a>&nbsp;<a href="newpic.php?objectid={logid}&type=1">Dodaj obrazek</a>&nbsp;';
