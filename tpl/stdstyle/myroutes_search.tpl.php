...
<div class="content2-pagetitle"><img src="tpl/stdstyle/images/blue/route.png" class="icon32" alt="" />&nbsp;{{search_caches_along_route}}: <span style="color: black;">{route_name} ({{radius}} {distance} km)</span></div>
