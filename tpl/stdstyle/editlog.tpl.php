...
function _chkFound () {
<?php 
	$sql = "SELECT count(cache_id) FROM cache_logs WHERE cache_id = (SELECT cache_id FROM cache_logs WHERE id = '".sql_escape(intval($_REQUEST['logid']))."') AND user_id = '".sql_escape($usr['userid'])."' AND type='1'";
...
<table class="content">
	<tr><td class="header" colspan="2"><img src="tpl/stdstyle/images/description/22x22-logs.png" border="0" width="22" height="22" alt="" title="edit log Cache" align="middle"> <b>Edycja logu dla skrzynki <a href="viewcache.php?cacheid={cacheid}">{cachename}</a></b></td></tr>
</table>
<table class="content">
