...
<br/>
<div class="searchdiv" style="background-color: #FFF9E3;"><span style="font-size: 13px; line-height:1.7em; text-align: justify;">Drogi Użytkowniku,<br/>
Dziękujemy za to, że chcesz zarejestrować swoja skrzynkę w serwisie opencaching.pl. Jeśli potrzebujesz pomocy w ukryciu lub rejestracji skrzynki, proszę zapoznaj się z informacjami zawartymi w <a class="links" href="http://wiki.opencaching.pl">OpenGeoWiki <img src="tpl/stdstyle/images/misc/linkicon.png" alt="link"></a> lub skontaktuj się z Centrum Obsługi Geocacher’a - adres email: cog@opencaching.pl
Pamiętaj, że Twoja skrzynka świadczy o Tobie. Na pewno zależy Ci na tym, by była jak najlepszej jakości, a w związku z tym prosimy o to, abyś odpowiedział sobie samodzielnie na poniższe pytania :<ul style="font-size: 14px; line-height:1.6em; text-align: left;color:blue;">
