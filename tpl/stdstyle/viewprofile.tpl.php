 ...
 ****************************************************************************/
?>
<div class="content2-pagetitle"><img src="tpl/stdstyle/images/blue/home.png" border="0" width="32" height="32" alt="{profile_data}" title="{profile_data}" align="middle">&nbsp;{username} {email} - {user_profile}</div>
<div class="content-title-noshade">
<p>
	<img src="/tpl/stdstyle/images/blue/email.png" width="32" height="32" border="0" alt="Email" title="Email" align="middle"/>&nbsp;<a href="mailto.php?userid={userid}">{email_user}</a><br/>
		<img src="/tpl/stdstyle/images/blue/world.png" width="32" height="32" border="0" alt="Mapa" title="Map" align="middle"/>&nbsp;<a href="cachemap2.php?userid={userid}">{show_user_map}</a>
	{hide_flag}<br/>
	{stat_ban}<br/>
	{remove_all_logs}<br/>
</p>
...
<table class="table" border="0">
	...
	<tr>
		<td colspan="2">
		<p class="content-title-noshade-size2"><img src="tpl/stdstyle/images/blue/profile.png" width="32" height="32" align="middle" border="0" alt="{user_desc}" title="Logs"/>&nbsp;{user_desc}</p></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
		<p class="content-title-noshade-size2"><img src="tpl/stdstyle/images/blue/profile.png" width="32" height="32" align="middle" border="0" alt="{profile_data}" title="Logs">&nbsp;{profile_data}</p></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
		<p class="content-title-noshade-size2"><img src="tpl/stdstyle/images/blue/cache.png" width="32" height="32" align="middle" border="0" alt="Logs" title="Logs"/>&nbsp;{hidden_caches}:</p></td>
		<td>
	...
	<tr>
		<td>
		<p class="content-title-noshade-size2">
		<img src="tpl/stdstyle/images/blue/stat1.png" width="32" height="32" align="middle" border="0" alt="{my_recommendations}" title="{my_recommendations}"/>&nbsp;{my_recommendations}:</p></td>
	...
	<tr>
		...
		<p class="content-title-noshade-size2">
			<img src="tpl/stdstyle/images/blue/logs.png" width="32" height="32" align="middle" border="0" alt="{my_recommendations}" title="{my_recommendations}">&nbsp;{user_new_log_entries}:
		</p>
		</td>
	</tr>
			{lastlogs}
