...
<tr>
<td rowspan="3" width="64"><img src="tpl/stdstyle/images/blue/profile1.png"  alt="" title="Profile" align="middle"/></td>
<td><span class="txt-blue08" >{{registered_since_label}}:</span> <span class="txt-black"> {registered}</span><br /><span class="txt-blue08" >{{country_label}}:</span><span class="txt-black"> {country}</span></td>
