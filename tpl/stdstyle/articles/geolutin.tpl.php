<table width=600 class="content">
	...
	<tr><td width=600 class="header"><img src="tpl/stdstyle/images/misc/32x32-tools.png" border="0" width="32" height="32" alt="ABC" title="ABC" align="middle"><font size="4">  <b>GeoLutin darmowa alternatywa dla Travel Bug</b></font></td></tr>
	<tr><td class="spacer"></td></tr>
</table>
<table width=600><tr><td>

Czy jest alternatywa dla "Travel Bug" (tzw balszki)?
<p>
Tak mo¿emy u¿yæ darmowego systemu do ¶ledzenia i tworzenia w³asnego
"Travle Bug" na stronie www.geolutins.com. Musimy zarejstrowaæ siê na
tej stronie i po za³o¿eniu konta mo¿emy generowaæ dowoln± ilo¶c Geolutinów.
Idea jest prosta, po wygenerowaniu GeoLutina dostajemy UID (unikalny numer)
dla nszego GeoLutina i drukujemy plakietkê która zawiera UID, nazwê GL i cel
jaki ma nasz GL. Po wydrukowaniu plakietki mo¿emy j± zafoliowaæ aby by³a
trwalsza i przyczepiamy j± do dowlnego przedmiotu (maskotka, breloczek, moneta
aparat itp) który bêdzie wêdrowa³ z skrzynki do skrzynki. Kiedy nasz GL jest gotowy
wk³adamy go do swojej skrzynki lub innej i fakt ten odnotowujemy na stronie naszgo
...
<p>
Mo¿emy te¿ na górze strony dodaæ zdjêcie z chowania lub znalezienia.
Mo¿na te¿ to zrobiæ pó¼niej wchodz±c w log danego GeoLutina

<p>
A tu jeszcze link do spolszczenia ¿eby by³o wiadomo jak to wygl±da
<a href=http://www.askibicki.com/geo/geolutinas.htm>TUTAJ</a>
<p>
<b><font color=red>TO NIE JEST STRONA DO REJESTRACJI TYLKO DO ZOBACZENIA JAK TO SIÊ ROBI</b></font>
