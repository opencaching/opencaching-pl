...
<?php if ($usr !== false){ 
echo '<img src="tpl/stdstyle/images/free_icons/chart_bar.png" class="icon16" alt="" title="" align="middle" />&nbsp;<a class="links" href="newcacherating.php">Ranking skrzynek według liczby rekomendacji</a><br />';
