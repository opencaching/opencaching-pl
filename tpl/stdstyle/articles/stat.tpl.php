...
<img src="tpl/stdstyle/images/free_icons/tick.png" class="icon16" alt="" title="" align="middle" />&nbsp;<a class="links" href="articles.php?page=s102&init=1&stat=FavoriteComments">{{fav_com}}</a><br />
