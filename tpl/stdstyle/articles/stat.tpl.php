...
<img src="tpl/stdstyle/images/free_icons/chart_bar.png" class="icon16" alt="" title="" align="middle" />&nbsp;<a class="links" href="articles.php?page=s11a">{{cache_ranking_by_finds_per_region}}</a><br />
<?php if ($usr !== false){ 
echo '<img src="tpl/stdstyle/images/free_icons/chart_bar.png" class="icon16" alt="" title="" align="middle" />&nbsp;<a class="links" href="cacheratings.php">{{cache_ranking_by_number_of_recommendations}}</a><br />';
