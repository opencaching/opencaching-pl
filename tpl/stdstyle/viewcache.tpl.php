...
<!-- Text container -->
{geokrety_begin}
			<div style="width:769px; height: 100px; margin:100 0 0 0;border-top:1px solid blue;border-left:1px solid blue;border-right:1px solid blue;border-bottom:1px solid blue;">
				<p class="content-title-noshade-size1">
