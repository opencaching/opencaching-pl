...
<div class="content2-container">
    <div class="content2-container-2col-left" id="viewcache-baseinfo">
        ...
        <p style="line-height: 1.6em;">
            ...
            <img src="tpl/stdstyle/images/<?php echo tpl_get_var('typeLetter') == 'e' ? 'cache/16x16-event.png' : 'free_icons/date.png'?>" class="icon16" alt="" title="" align="middle" />&nbsp;<?php echo tr( tpl_get_var('typeLetter') == 'e' ? 'date_event_label' : 'date_hidden_label')?>: {hidden_date}<br />
...
<div class="content2-container bg-blue02">
    <p class="content-title-noshade-size1" id="logs_more_start">
        ...
        <a href="viewlogs.php?cacheid={cacheid_urlencode}" >
            <img src="tpl/stdstyle/images/action/16x16-showall.png" class="icon16" alt="{{show_all_log_entries_short}}" title="{{show_all_log_entries_short}}"/></a>&nbsp;<a title="{{show_all_log_entries_short}}" href="viewlogs.php?cacheid={cacheid_urlencode}&amp;showlogsall=y">{{show_all_log_entries_short}}</a>
    </p>
</div>
{viewlogs_end}
<!-- End Text Container -->
