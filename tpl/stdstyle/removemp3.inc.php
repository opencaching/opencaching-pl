...
$message_toobig = 'Wybrany plik jest za duży. Postaraj się zmniejszyć go poprzez zmiane jakości.';

$message_title_wrongext = 'Typ pliku nieropoznany';
$message_wrongext = 'Wybrany plik ma nieznany format. Dozwolone są tylko typy MP3.';
?>
