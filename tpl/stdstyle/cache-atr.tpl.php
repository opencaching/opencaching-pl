...
<tr><td align="center">
<?php
 if ($atr2 == ivy) echo '<img src="/images/cacheatr/ivy.gif" border="1" title="'.$language[$lang]['toxic_plants'].'">';
 if ($atr3 == thorn) echo '<img src="/images/cacheatr/thorn.gif" border="1" title="'.$language[$lang]['thorns'].'">';
 if ($atr4 == trash) echo '<img src="/images/cacheatr/trash.gif" border="1" title="'.$language[$lang]['cito'].'">';
 if ($atr5 == yes) echo '<img src="/images/cacheatr/dog2.gif" border="1" title="'.$language[$lang]['dogs_allowed'].'">';
 if ($atr5 == no) echo '<img src="/images/cacheatr/dog0.gif" border="1" title="'.$language[$lang]['dogs_not_allowed'].'">';
 if ($atr6 == yes) echo '<img src="/images/cacheatr/date.gif" border="1" title="'.$language[$lang]['all_year'].'">';
 if ($atr6 == no) echo '<img src="/images/cacheatr/date0.gif" border="1" title="'.$language[$lang]['not_all_year'].'">';
 if ($atr8 == yes) echo '<img src="/images/cacheatr/snow_icon.gif" border="1" title="'.$language[$lang]['accessible_winter'].'">';
 if ($atr8 == no) echo '<img src="/images/cacheatr/snow_icon0.gif" border="1" title="'.$language[$lang]['not_accessible_winter'].'">';
 if ($atr9 == weather) echo '<img src="/images/cacheatr/weather.gif" border="1" title="'.$language[$lang]['depends_weather'].'">';
 if ($atr11 == yes) echo '<img src="/images/cacheatr/bike2.gif" border="1" title="'.$language[$lang]['bikes_allowed'].'">';
 if ($atr11 == no) echo '<img src="/images/cacheatr/bike0.gif" border="1" title="'.$language[$lang]['bikes_not_allowed'].'">';
 if ($atr12 == car) echo '<img src="/images/cacheatr/car.gif" border="1" title="'.$language[$lang]['cars_allowed'].'">';
 if ($atr13 == spelunk) echo '<img src="/images/cacheatr/spelunk.gif" border="1" title="'.$language[$lang]['cave'].'">';
 if ($atr14 == yes) echo '<img src="/images/cacheatr/offtrail12.gif" border="1" title="'.$language[$lang]['outside_path_allowed'].'">';
 if ($atr14 == no) echo '<img src="/images/cacheatr/offtrail0.gif" border="1" title="'.$language[$lang]['outside_path_not_allowed'].'">';
 if ($atr15 == yes) echo '<img src="/images/cacheatr/offroad1.gif" border="1" title="'.$language[$lang]['drive_outside_road_allowed'].'">';
 if ($atr15 == no) echo '<img src="/images/cacheatr/offroad0.gif" border="1" title="'.$language[$lang]['drive_outside_road_not_allowed'].'">';
 if ($atr16 == hydro) echo '<img src="/images/cacheatr/hydro.gif" border="1" title="'.$language[$lang]['water_cache'].'">';
 if ($atr18 == wading) echo '<img src="/images/cacheatr/wading.gif" border="1" title="'.$language[$lang]['wading'].'">';
 if ($atr19 == swimming) echo '<img src="/images/cacheatr/swim_icon.gif" border="1" title="'.$language[$lang]['swimming_pool_nearby'].'">';
 if ($atr20 == mud) echo '<img src="/images/cacheatr/mud1.gif" border="1" title="'.$language[$lang]['warning_mud'].'">';
 if ($atr21 == smokey) echo '<img src="/images/cacheatr/smokey.gif" border="1" title="'.$language[$lang]['fire_danger'].'">';
 if ($atr22 == tbughotel) echo '<img src="/images/cacheatr/tbughotel.gif" border="1" title="'.$language[$lang]['travel_bug_hotel'].'">';
 if ($atr24 == yes) echo '<img src="/images/cacheatr/handicap.gif" border="1" title="'.$language[$lang]['handicap_allowed'].'">';
 if ($atr24 == no) echo '<img src="/images/cacheatr/handicap0.gif" border="1" title="'.$language[$lang]['handicap_not_allowed'].'">';
 if ($atr26 == grab) echo '<img src="/images/cacheatr/grab.gif" border="1" title="'.$language[$lang]['can_drive_in'].'">';
 if ($atr28 == noshorts) echo '<img src="/images/cacheatr/noshorts.gif" border="1" title="'.$language[$lang]['no_shorts'].'">';
 if ($atr29 == hunting) echo '<img src="/images/cacheatr/hunting.gif" border="1" title="'.$language[$lang]['hunting_area'].'">';
 if ($atr30 == supervise) echo '<img src="/images/cacheatr/supervise.gif" border="1" title="'.$language[$lang]['danger_area'].'">';
 if ($atr31 == yes) echo '<img src="/images/cacheatr/rest.gif" border="1" title="'.$language[$lang]['toilet_nearby'].'">';
 if ($atr31 == no) echo '<img src="/images/cacheatr/norest.gif" border="1" title="'.$language[$lang]['no_toilet_nearby'].'">';
 if ($atr32 == drink) echo '<img src="/images/cacheatr/drink.gif" border="1" title="'.$language[$lang]['drink_water'].'">';
 if ($atr33 == hiking) echo '<img src="/images/cacheatr/hiking.gif" border="1" vspace="1" title="'.$language[$lang]['hiking'].'">';
 if ($atr34 == pencil) echo '<img src="/images/cacheatr/pencil.gif" border="1" title="'.$language[$lang]['take_pencil'].'">';
 if ($atr35 == easyclimb) echo '<img src="/images/cacheatr/climb.gif" border="1" title="'.$language[$lang]['easy_climb'].'">';
 if ($atr36 == steep) echo '<img src="/images/cacheatr/steep.gif" border="1" title="'.$language[$lang]['medium_climb'].'">';
 if ($atr37 == exclimb) echo '<img src="/images/cacheatr/exclimb.gif" border="1" title="'.$language[$lang]['extreme_climb'].'">';
 if ($atr38 == horses) echo '<img src="/images/cacheatr/ears.gif" border="1" title="'.$language[$lang]['horse_path'].'">';
 if ($atr39 == tide) echo '<img src="/images/cacheatr/tide.gif" border="1" title="'.$language[$lang]['check_tide'].'">';
 if ($atr40 == compass) echo '<img src="/images/cacheatr/compass.gif" border="1" title="'.$language[$lang]['take_compass'].'">';
 if ($atr41 == sight) echo '<img src="/images/cacheatr/sight.gif" border="1" title="'.$language[$lang]['sights'].'">';
 if ($atr43 == skeeter) echo '<img src="/images/cacheatr/skeeter.gif" border="1" title="'.$language[$lang]['skeeter'].'">';
 if ($atr44 == ticks) echo '<img src="/images/cacheatr/tick2.gif" border="1" title="'.$language[$lang]['tick'].'">';
 if ($atr45 == snakes) echo '<img src="/images/cacheatr/snake.gif" border="1" title="'.$language[$lang]['snake'].'">';
?>
</td></tr></table>
<br><br>
<h1><b>Kod który należy wkleić do opisu skrzynki. <br>Uwaga przed wklejeniem kodu edytor opisu szkrzynki należy przełączyć w tryb HTML!</b></h1><br>
