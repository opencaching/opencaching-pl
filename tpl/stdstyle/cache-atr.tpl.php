...
<?php
 ...
 if ($atr5 == yes) echo '<img src="/images/cacheatr/dog2.gif" border="1" title="'.tr('dogs_allowed').'" />';
 if ($atr5 == no) echo '<img src="/images/cacheatr/dog0.gif" border="1" title="'.tr('dogs_not_allowed').'" />';
 if ($atr6 == yes) echo '<img src="/images/cacheatr/date.gif" border="1" title="'.tr('all_year').'" />';
 if ($atr6 == no) echo '<img src="/images/cacheatr/date0.gif" border="1" title="'.tr('not_all_year').'" />';
 if ($atr8 == yes) echo '<img src="/images/cacheatr/snow_icon.gif" border="1" title="'.tr('accessible_winter').'" />';
 if ($atr8 == no) echo '<img src="/images/cacheatr/snow_icon0.gif" border="1" title="'.tr('not_accessible_winter').'" />';
 if ($atr9 == weather) echo '<img src="/images/cacheatr/weather.gif" border="1" title="'.tr('depends_weather').'" />';
 if ($atr11 == yes) echo '<img src="/images/cacheatr/bike2.gif" border="1" title="'.tr('bikes_allowed').'" />';
 if ($atr11 == no) echo '<img src="/images/cacheatr/bike0.gif" border="1" title="'.tr('bikes_not_allowed').'" />';
 if ($atr12 == car) echo '<img src="/images/cacheatr/car.gif" border="1" title="'.tr('cars_allowed').'" />';
 if ($atr13 == spelunk) echo '<img src="/images/cacheatr/spelunk.gif" border="1" title="'.tr('cave').'" />';
 if ($atr14 == yes) echo '<img src="/images/cacheatr/offtrail12.gif" border="1" title="'.tr('outside_path_allowed').'" />';
 if ($atr14 == no) echo '<img src="/images/cacheatr/offtrail0.gif" border="1" title="'.tr('outside_path_not_allowed').'" />';
 if ($atr15 == yes) echo '<img src="/images/cacheatr/offroad1.gif" border="1" title="'.tr('drive_outside_road_allowed').'" />';
 if ($atr15 == no) echo '<img src="/images/cacheatr/offroad0.gif" border="1" title="'.tr('drive_outside_road_not_allowed').'" />';
 if ($atr16 == hydro) echo '<img src="/images/cacheatr/hydro.gif" border="1" title="'.tr('water_cache').'" />';
 if ($atr18 == wading) echo '<img src="/images/cacheatr/wading.gif" border="1" title="'.tr('wading').'" />';
 if ($atr19 == swimming) echo '<img src="/images/cacheatr/swim_icon.gif" border="1" title="'.tr('swimming_pool_nearby').'" />';
 if ($atr20 == mud) echo '<img src="/images/cacheatr/mud1.gif" border="1" title="'.tr('warning_mud').'" />';
 if ($atr21 == smokey) echo '<img src="/images/cacheatr/smokey.gif" border="1" title="'.tr('fire_danger').'" />';
 if ($atr22 == tbughotel) echo '<img src="/images/cacheatr/tbughotel.gif" border="1" title="'.tr('travel_bug_hotel').'" />';
 if ($atr24 == yes) echo '<img src="/images/cacheatr/handicap.gif" border="1" title="'.tr('handicap_allowed').'" />';
 if ($atr24 == no) echo '<img src="/images/cacheatr/handicap0.gif" border="1" title="'.tr('handicap_not_allowed').'" />';
 if ($atr26 == grab) echo '<img src="/images/cacheatr/grab.gif" border="1" title="'.tr('can_drive_in').'" />';
 if ($atr28 == noshorts) echo '<img src="/images/cacheatr/noshorts.gif" border="1" title="'.tr('no_shorts').'" />';
 if ($atr29 == hunting) echo '<img src="/images/cacheatr/hunting.gif" border="1" title="'.tr('hunting_area').'" />';
 if ($atr30 == supervise) echo '<img src="/images/cacheatr/supervise.gif" border="1" title="'.tr('danger_area').'" />';
 if ($atr31 == yes) echo '<img src="/images/cacheatr/rest.gif" border="1" title="'.tr('toilet_nearby').'" />';
 if ($atr31 == no) echo '<img src="/images/cacheatr/norest.gif" border="1" title="'.tr('no_toilet_nearby').'" />';
 if ($atr32 == drink) echo '<img src="/images/cacheatr/drink.gif" border="1" title="'.tr('drink_water').'" />';
 if ($atr33 == hiking) echo '<img src="/images/cacheatr/hiking.gif" border="1" vspace="1" title="'.tr('hiking').'" />';
 if ($atr34 == pencil) echo '<img src="/images/cacheatr/pencil.gif" border="1" title="'.tr('take_pencil').'" />';
 if ($atr35 == easyclimb) echo '<img src="/images/cacheatr/climb.gif" border="1" title="'.tr('easy_climb').'" />';
 if ($atr36 == steep) echo '<img src="/images/cacheatr/steep.gif" border="1" title="'.tr('medium_climb').'" />';
 if ($atr37 == exclimb) echo '<img src="/images/cacheatr/exclimb.gif" border="1" title="'.tr('extreme_climb').'" />';
 if ($atr38 == horses) echo '<img src="/images/cacheatr/ears.gif" border="1" title="'.tr('horse_path').'" />';
 if ($atr39 == tide) echo '<img src="/images/cacheatr/tide.gif" border="1" title="'.tr('check_tide').'" />';
 if ($atr40 == compass) echo '<img src="/images/cacheatr/compass.gif" border="1" title="'.tr('take_compass').'" />';
 if ($atr41 == sight) echo '<img src="/images/cacheatr/sight.gif" border="1" title="'.tr('sights').'" />';
 if ($atr43 == skeeter) echo '<img src="/images/cacheatr/skeeter.gif" border="1" title="'.tr('skeeter').'" />';
 if ($atr44 == ticks) echo '<img src="/images/cacheatr/tick2.gif" border="1" title="'.tr('tick').'" />';
 if ($atr45 == snakes) echo '<img src="/images/cacheatr/snake.gif" border="1" title="'.tr('snake').'" />';
?>
</td></tr></table>
<br /><br />
