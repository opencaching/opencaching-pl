 ...
 ****************************************************************************/
 ...
 $tpl_line = '<tr><td width="22">{date}</td><td width="22">&nbsp;<img src="images/flags/{country}.png" border="0" alt="{country_name}" title="{country_name}" style="margin-top:4px;" /></td><td width="22">{gkimage}</td><td width="22">{log_image}</td><td width="22"><img src="{imglink}" class="icon16" alt="Cache" title="Cache" style="margin-top:4px;" /></td><td><b><a class="links" href="viewcache.php?cacheid={cacheid}">{cachename}</a></b></td><td><b><a class="links" href="viewprofile.php?userid={userid}">{username}</a></b></td></tr>';
?>
