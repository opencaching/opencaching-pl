 ...
 ****************************************************************************/
 ...
 $tpl_line = '<tr><td style="width: 70px;">{date}</td><td></td><td width="22">{gkimage}</td><td width="22">{log_image}</td><td width="22"><img src="{imglink}" class="icon16" alt="Cache" title="Cache" style="margin-top:4px;" /></td><td><b><a class="links" href="viewcache.php?cacheid={cacheid}">{cachename}</a></b></td><td><span class="txt-blue10">{region}</span></td><td><b><a class="links" href="viewprofile.php?userid={userid}">{username}</a></b></td></tr>';
?>
