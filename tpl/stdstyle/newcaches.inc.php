 ...
 ****************************************************************************/
 ...
 $tpl_line = '{date} ({country}): <img src="{imglink}" width="16" height="16" border="0" alt="Cache" title="Cache" style="margin-top:4px;" /> <a href="viewcache.php?cacheid={cacheid}">{cachename}</a> {{hidden_by}} <a href="viewprofile.php?userid={userid}">{username}</a><br />';
?>
