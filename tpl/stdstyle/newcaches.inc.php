 ...
 ****************************************************************************/
 ...
 $tpl_line = '<tr><td>{date}</td><td><img src="images/flags/{country}.gif" border="0" alt="Country" title="Country" style="margin-top:4px;" /></td><td><img src="{imglink}" width="16" height="16" border="0" alt="Cache" title="Cache" style="margin-top:4px;" /></td><td><a href="viewcache.php?cacheid={cacheid}">{cachename}</a></td><td><a href="viewprofile.php?userid={userid}">{username}</a></td></tr>';
?>
