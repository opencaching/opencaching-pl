...
$translations = array(
    ...
    'register_msg6' => 'The activation code has been sent to your e-mail address. <br/> In order to complete the registration process, please follow the instructions provided in that email message. <br/> <b> Warning! Some mail servers may reject or mark as spam the activation email from our system. Please also check your Spam folder as well. If you do not receive the code within the next few hours, please contact us at <span class = "email">{contact_mail}</span>. <b>Be sure to include the username and e-mail address you registered with.</b>',
    'register_msg7' => 'Users that posted at least one log entry or published at least one cache can not be deleted. <br />It is however possible to deactivate your account. All your personal data will be removed (including your email address), but your username will be kept. If you want to deactivate your account, please contact us at <span class = "email">{contact_mail}</span>. Thank you.',
    ...
    'registermail05' => 'If you\'re looking for help through an interactive map where you can find volunteers who offer their help to beginner geocachers.',
    'registermail06' => 'Look at page:',
    'registermail07' => 'Before you register your first cache on OC PL you must find 10 caches of follwing types:traditional, quiz, multicache and other type.***',
