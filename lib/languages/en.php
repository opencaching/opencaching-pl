...
$translations = array(
    ...
    'activation_error1' => 'There was a problem during activating your account. Check the address in the address bar agrees with the link received in the mail. In case of further problems, please contact us: <span class="mail">{contact_mail}</span> .',
    'activation_error2' => 'Your account appears to be active. Have you tried to log in? In case of further problems, please contact us: <span class="mail">{contact_mail}</span> .',
    ...
    'gray_field_is_hidden' => 'Grey fields are not visible for other users.',
    ...
    'no_auto_logout_warning' => 'Warning! If you use this option, be aware that being permanently logged in means someone else might access your account.',
    ...
    'creating_cache' => 'By creating a new cache you accept {site_name}\'s <a href="{wiki_link_rules}" target="_blank">Terms of Use</a>.',
    ...
    'ozi_path_info' => 'Applicable to Ozi Explorer users with Filips\' database. When you provide correct path to "op" folder, you will be able to download WPT files as search results with localization of information about cache description. After that, you can tap on the cache on Ozi Explorer\'s map and choose \"Open attachment\" option. This will open detailed description about the cache. Examples: <b>\\SDMMC\\baza\\</b>, <b>\\Memory card\\BF\\</b>***',
    ...
    'register_msg1' => 'To create an account on {site_name}, you have to enter a vaild E-Mail address and an username. <br/>An E-Mail will be sent to the address you supplied with an activation link. Only one account can be created per one E-Mail address.',
    ...
    'register_msg6' => 'The activation link was sent via E-mail to you. Please follow the instructions within it. Check your spam folder if you didn\'t see message from us.',
    'register_msg7' => 'Users which have hidden a cache or logged at least one visit (no matter what type) cannot be deleted. However, it is possible to deactivate such accounts. All your personal data will be removed (including your email address), but your username will be kept. If you want your account to be deactivated contact us at {contact_mail} .',
    ...
    'error_username_exists' => 'The chosen username is already registered. Please select other name.',
    ...
    'error_tos' => 'You have to agree to <a href="{wiki_link_rules}" target="_blank">Terms of Use</a> of {site_name}',
    'step1' => 'Step 1',
    'step2' => 'Step 2',
    ...
    'caches_waiting_approve' => 'Caches which are waiting for approval by OC Team',
    ...
    'myprofile07' => '{site_name} uses coordinates to calculate distance to caches on the map that are available publicly. If you are worried about publishing the coordinates, use coordinates of the nearest park, bar... or just set a couple of last digits to zeroes.',
    ...
    'send_to' => 'Send to',
    'send_to_cgeo' => 'c:geo',
    'postactivationmail01' => 'To have a good start, you can read most information on our OpenGeoWiki. You can find OpenGeoWiki at:',
    'postactivationmail02' => 'If you\'re looking for help through an interactive map where you can find volunteers who offer their help to beginner geocachers.',
    'postactivationmail03' => 'Map of the guides you can see here:',
    'postactivationmail04' => 'Before you register your first cache on {site_name} you must find {NEED_FIND_LIMIT} caches of follwing types: traditional, quiz, multicache and other type.',
    'postactivationmail05' => 'Your first {NEED_APPROVE_LIMIT} caches will be moderated by OC Team.',
    'useractivationmail1' => 'We have saved the next data from you for registration:',
    ...
    'useractivationmail6' => 'If you don\'t activate your account withing the next 14 days, your account will be automatically deleted.',
);
