...
$translations = array(
    ...
    'first_cache' => 'If it is the first time you are placing a cache, please read the following <a href="{wiki_link_cacheParams_en}" target="_blank">basic information</a>',
    ...
    'waypoint_other_portal_info' => 'Waypoints reserved for this cache on other geocaching websites.',
    ...
    'hint_long_text' => 'Optional encrypted hint. This is <b>NOT</b> required. <br />Your can write some additional hints here. Please be brief.',
    ...
    'newcache_import_wpt_help' => 'This feature allows you to get waypoint data (coords, name) from gpx file. (f.ex.&nbsp;from garmin).',
