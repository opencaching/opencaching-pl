/*
  ...
  "Philip D. Bober" <wildfire1138@mchsi.com>
   Modified by "Damian Kaczmarek" <rush@rushbase.net>
 */
#ifndef __SAVETOPNG_H__
#define __SAVETOPNG_H__
...
/**
 * Takes a file handle, a surface to save, and a compression level.  The
