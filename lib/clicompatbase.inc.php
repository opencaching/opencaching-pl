 ...
 ****************************************************************************/
    ...
    define('regex_username', '^[a-zA-Z0-9ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂ0-9\.\-_ @ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂäüöÄÜÖ=)(\/\\\&*+~#]{2,59}$');
    define('regex_password', '^[a-zA-Z0-9\.\-_ @ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂäüöÄÜÖ=)(\/\\\&*+~#]{3,60}$');
    define('regex_last_name', '^[a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂ0-9\.\- ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂäüöÄÜÖ]{1,59}$');
    define('regex_first_name', '^[a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂ0-9\.\- ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂäüöÄÜÖ]{1,59}$');
    define('regex_statpic_text', '^[a-zA-Z0-9\.\-_ ęóąśłżźćńĘÓĄŚŁŻŹĆŃăîşţâĂÎŞŢÂ@äüöÄÜÖß=)(\/\\\&*\$+~#!§%;,-?:\[\]{}123\'\"`\|µ°]{0,29}$');
