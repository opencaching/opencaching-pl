 ...
 ****************************************************************************/
    ...
    define('regex_username', '^[a-zA-Z0-9ęóąśłżźćńĘÓĄŚŁŻŹĆŃ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ0-9\.\-_ @ęóąśłżźćńĘÓĄŚŁŻŹĆŃäüöÄÜÖ=)(\/\\\&*+~#]{2,59}$');
    define('regex_password', '^[a-zA-Z0-9\.\-_ @ęóąśłżźćńĘÓĄŚŁŻŹĆŃäüöÄÜÖ=)(\/\\\&*+~#]{3,60}$');
    define('regex_last_name', '^[a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ0-9\.\- ęóąśłżźćńĘÓĄŚŁŻŹĆŃäüöÄÜÖ]{1,59}$');
    define('regex_first_name', '^[a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ][a-zA-ZęóąśłżźćńĘÓĄŚŁŻŹĆŃ0-9\.\- ęóąśłżźćńĘÓĄŚŁŻŹĆŃäüöÄÜÖ]{1,59}$');
    define('regex_statpic_text', '^[a-zA-Z0-9\.\-_ ęóąśłżźćńĘÓĄŚŁŻŹĆŃ@äüöÄÜÖß=)(\/\\\&*\$+~#!§%;,-?:\[\]{}123\'\"`\|µ°]{0,29}$');
