 ...
 *				t.drawTable();
 *
 *				nrPosArray = t.getFilteredRows([{column: 1, value: 42}, {column: 0, minValue: 'Bob', maxValue: 'Jim'}])
 * 
 ************************************************ 
 */
...
function GCT( divId ){
	...
	this.getFilteredRows; /* function( filterArray ) */
	
	//Page Navigation
	this.goToPage; /* function( nrPage ) */
	this.goToPosition; /* function( nrPos ) */
}
...
GCT.prototype.addToLastRow = function ( nrCol, value, formatValue )
{
	...
	this.GCTdata.setCell( nrRow-1 , nrCol, value, formatValue );
...
{	
	this.GCTdata.getFilteredRows( filterArray );	
};

GCT.prototype.goToPage = function( nrPage )
{	
	this.addTblOption( 'startPage', nrPage );
	this.__drawTable( this.GCTdata, this.TblOptions );	
};

GCT.prototype.goToPosition = function( nrPos )
{	
