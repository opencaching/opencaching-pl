...
function GCT( divId ){
	...
	//css: GCT.css
	this.vcssClassNames = {
	    'headerRow': 'GCT-background-color-white6 GCT-color-blueOC GCTalign-left GCT-font-bold',
	    'tableRow': 'GCT-background-color-white GCT-color-black',
	    'oddTableRow': 'GCT-background-color-whiteB  GCT-color-black',
	    'selectedTableRow': 'GCT-background-color-grey25',
	    'hoverTableRow': 'GCT-color-darkred',
	    'headerCell': 'GCT-border-color-grey',
	    'tableCell': 'GCT-border-color-grey',
