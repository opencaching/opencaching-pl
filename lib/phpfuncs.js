function get_html_translation_table (table, quote_style) {
    ...
    useTable       = !isNaN(table) ? constMappingTable[table] : table ? table : 'HTML_SPECIALCHARS';
    useQuoteStyle = !isNaN(quote_style) ? constMappingQuoteStyle[quote_style] : quote_style ? quote_style : 'ENT_COMPAT';
