...
function fHideColumn( $nr, $set )
{
    ...
    $colNameSearch = array(
                    ...
                    7 => array("C" => tr('F'), "O" => tr('Found')),
                    8 => array("C" => tr('N'), "O" => tr('NotFound')),
                    9 => array("C" => tr('C'), "O" => tr('Comment')),
                    10 => array("C" => "<img src='images/rating-star.png'>", "O" => tr('RecommendationNumber')),
                    11 => array("C" => tr('Entry'), "O" => tr('TypeDateLastEntry')),
                    12 => array("C" => tr('type'), "O" => tr('LastTypeEntry')),
                    13 => array("C" => tr('date_logged'), "O" => tr('LastEntryDate')),
                    14 => array("C" => tr('content'), "O" => tr('LastEntryContent')),
