...
function MarkerLight(latlng, opts) {
    ...
    this.height_ = opts.height || 16;
    this.width_ = opts.width || 16;
    this.image_ = opts.image || "images/bluecirclemarker.png";
    this.imageOver_ = opts.imageOver;
    this.clicked_ = 0;
    this.value_ = opts.value || 0;

    this.height_ = this.height_ * ((this.value_ / 100) + 1);
    this.width_ = this.width_ * ((this.value_ / 100) + 1);
}
...
//    }
//    else if ((me.value_ % 4) === 2) {
//        div.style.border = "2px solid green";
//    }
//    else if ((me.value_ % 4) === 3) {
...
/*
    if ((me.value_ % 4) === 1) {
            img.src = "images/yellowcirclemarker.png";
    }
    else if ((me.value_ % 4) === 2) {
        img.src = "images/greencirclemarker.png";
    }
    else if ((me.value_ % 4) === 3) {
    img.src = "images/redcirclemarker.png";
    }
    else {
        img.src = "images/bluecirclemarker.png";
    }
  */
    img.src = "../tpl/stdstyle/images/google_maps/foundC0.png";
...
MarkerLight.prototype.openInfoWindowHtml = function(text)
{
    var div = document.createElement("div");
    //div.style.border = "1px solid white";
